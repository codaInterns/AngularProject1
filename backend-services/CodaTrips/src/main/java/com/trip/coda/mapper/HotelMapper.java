...
public interface HotelMapper {
  ...
  @Insert("insert into hotels"
      + "(hotelDescription,hotelImage,hotelName,hotelPlace,hotelPrice) "
      + "values(#{hotelDescription},#{hotelImage},#{hotelName},#{hotelPlace},#{hotelPrice})")
  @SelectKey(statement = "select  LAST_INSERT_ID() ",
      keyProperty = "hotelId", before = false, resultType = int.class)
